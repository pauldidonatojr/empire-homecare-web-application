...
const EmptyState=()=>{
    return(
        <View style={{marginTop:"50%",alignItems:"center"}}>
            <Text style={{fontSize:20}}>Hey ! No Visits Scheduled Today</Text>
            <Text style={{fontSize:15,fontWeight:"bold"}}>If this is an error message, contact your agency</Text>
        </View>
    )
}
...
const UnScheduleVisits = ({ navigation }) => {
  return (
...
export default UnScheduleVisits;