    ...
    return (
        <View style={{ width: '100%', height: '100%' }}>
            ...
            <View style={styles.filterHolder}>
                ...
                >
                    <Text style={{ color: 'white' }}>Select Filters</Text>
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.selectorScrollView}>
                <ScrollView>
                    ...
                    <View style={styles.tableHolder}>
                        <View style={{ width: '100%', height: '100%' }}>
                            <Text style={{ fontWeight: 'bold', flex: 1, justifyContent: "center", alignItems: "center", textAlignVertical: "center", textAlign: "center", color: '#1B365C' }}>Pending Placements</Text>
                        </View>
                    </View>
                    {/*  */}
                    ...
                    <View style={styles.tableHolder}>
                        <View style={{ width: '100%', height: '100%' }}>
                            <Text style={{ fontWeight: 'bold', flex: 1, justifyContent: "center", alignItems: "center", textAlignVertical: "center", textAlign: "center", color: '#1B365C' }}>Notes</Text>
                        </View>
                    </View>
                    {/*  */}
...
export default LinkCommunications;