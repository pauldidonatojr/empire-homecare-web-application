        ...
        <View style={{ width: '100%', height: '100%' }}>
            ...
            <View style={styles.filterHolder}>
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => {
                        navigation.navigate('Search Care Giver')
                    }}
                >
                    <Text style={{ color: 'white' }}>Search Care Giver</Text>
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.filterHolder}>
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => {
                        navigation.navigate('New Care Giver')
                    }}
                >
                    <Text style={{ color: 'white' }}>Add New Care Giver</Text>
                </TouchableOpacity>
            </View>
