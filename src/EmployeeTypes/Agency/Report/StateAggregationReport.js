...
const ByBatch = () => {
  ...
  const ReportSectionDropdown= [
    { key: "1", value: "CareGiver" },
    { key: "2", value: "Member" },
    { key: "2", value: "Visit" },
  ];
  const RecordStatusDropdown= [
    { key: "1", value: "Active" },
    { key: "2", value: "In Active" },
  ];
  const ProcudureCodeDropdown= [
    { key: "1", value: "Active" },
    { key: "2", value: "In Active" },
  ];
      ...
      <View>
        ...
        >
          ...
          <ScrollView>
            ...
            <TextInput style={styles.input} placeholder="Last Export From Date DD/MM/YY" />

            <TextInput
              style={styles.input}
              placeholder="Last Export To Date DD/MM/YY"
            />
            <TextInput
              style={styles.input}
              placeholder="Member"
            ...
            <View style={styles.dropdown}>
              <SelectList
                setSelected={(val) => setSelected(val)}
                data={ProcudureCodeDropdown}
                placeholder="Procudure Code (s)"
                save="value"
              />
            </View>
            <View style={styles.dropdown}>
              <SelectList
                setSelected={(val) => setSelected(val)}
                data={RecordStatusDropdown}
                placeholder="Record Status (es)"
                save="value"
              />
            </View>
