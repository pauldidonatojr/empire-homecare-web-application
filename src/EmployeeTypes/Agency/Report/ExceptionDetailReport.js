...
const ExceptionDetailReport = () => {
  ...
  const AdmissionIDDropdown = [
    { key: "1", value: "Active" },
    { key: "2", value: "In Active" },
  ];
  const IncludeTypeDropdown = [
    { key: "1", value: "Active" },
    { key: "2", value: "In Active" },
  ];
      ...
      <View>
        ...
        >
          ...
          <ScrollView>
            ...
            <TextInput style={styles.input} placeholder="From To DD/MM/YY" />
            ...
            <View style={styles.dropdown}>
              <SelectList
                setSelected={(val) => setSelected(val)}
                data={ExceptionCodeDropdown}
                placeholder="ExceptionCode"
                save="value"
              />
            </View>
...
export default ExceptionDetailReport;
