...
const Scheduling = () => {
  ...
  const DiciplineDropdown = [
    { key: "1", value: "Active" },
    { key: "2", value: "In Active" },
  ];
  const CheckMarksDropdown = [
    { key: "1", value: "Include Break After MCO / Due Date" },
    { key: "2", value: "Authorization Marked as TEMP" },
    { key: "3", value: "Include Members with No Authorization" },
    { key: "4", value: "Display Atl. Member ID" },
    { key: "5", value: "Display Medical Number" },
    { key: "6", value: "No Furthur Authorization" },

    { key: "7", value: "Other Authorization" },

    { key: "5", value: "Display Latest Only" },
  ];
  const TeamDropdown = [
    { key: "1", value: "Active" },
    { key: "2", value: "In Active" },
        ...
        >
          ...
          <ScrollView>
            ...
            <View style={styles.dropdown}>
              <SelectList
                setSelected={(val) => setSelected(val)}
                data={CheckMarksDropdown}
                placeholder="Check Marks"
                save="value"
              />
            </View>
