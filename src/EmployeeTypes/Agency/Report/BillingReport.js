    ...
    <View style={{ width: "100%", height: "100%" }}>
      ...
      <View>
        ...
        >
          ...
          ></Icon>
          <ScrollView>
          <TextInput style={styles.input} placeholder="Visit From Date DD/MM/YY" />
          <TextInput style={styles.input} placeholder="Visit To Date DD/MM/YY" />

            <View style={styles.dropdown}>
              <SelectList
                setSelected={(val) => setSelected(val)}
                data={ContractDropdown}
                placeholder="Contract"
                save="value"
              />
            </View>
            <TextInput style={styles.input} placeholder="Invoice From Date DD/MM/YY" />

            <TextInput style={styles.input} placeholder="Invoice To Date DD/MM/YY" />
            <TextInput style={styles.input} placeholder="Invoice Number" />

            <TextInput style={styles.input} placeholder="Batch From Date DD/MM/YY" />
            <TextInput style={styles.input} placeholder="Batch To Date DD/MM/YY" />
            <TextInput style={styles.input} placeholder="Batch Number" />
            <TextInput style={styles.input} placeholder="CareGiver" />
            <TextInput style={styles.input} placeholder="Member" />

            <View style={styles.dropdown}>
              <SelectList
                setSelected={(val) => setSelected(val)}
                data={GroupByDropdown}
            ...
            <View style={styles.dropdown}>
              <SelectList
                setSelected={(val) => setSelected(val)}
                data={ServiceCodeDropdown}
                placeholder="Service Code (s)"
                save="value"
              />
            </View>
