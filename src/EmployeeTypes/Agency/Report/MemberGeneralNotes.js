...
const MemberGeneralNotes = () => {
  ...
  const LinkedNotesFromDropdown= [
    { key: "1", value: "Active" },
    { key: "2", value: "In Active" },
  ];
  const LinkedNotesToDropdown= [
    { key: "1", value: "Active" },
    { key: "2", value: "In Active" },
  ];
  ...
  const ReasonDropdown= [
    { key: "1", value: "Member General Notes" },
    { key: "2", value: "Calender Notes" },
    { key: "3", value: "Visit CareGiver Comments" },
    { key: "4", value: "Missed Visit Notes" },
  ];
  const NotesTypeDropdown= [
    { key: "1", value: "Active" },
    { key: "2", value: "In Active" },
  ];
        ...
        >
          ...
          <ScrollView>
            ...
            <View style={styles.dropdown}>
              <SelectList
                setSelected={(val) => setSelected(val)}
                data={LinkedNotesFromDropdown}
                placeholder="Linked Notes From"
                save="value"
              />
            </View>
            <View style={styles.dropdown}>
              <SelectList
                setSelected={(val) => setSelected(val)}
                data={LinkedNotesToDropdown}
                placeholder="Linked Notes To"
                save="value"
              />
              </View>
              <View style={styles.dropdown}>
...
export default MemberGeneralNotes;
