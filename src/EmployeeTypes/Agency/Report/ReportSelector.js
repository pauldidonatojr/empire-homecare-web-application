...
const ReportSelector = ({ navigation }) =>{
    return (
        <View style={{ width: '100%', height: '100%' }}>
            ...
            <ScrollView>
              ...
              <TouchableOpacity
                style={styles.scrollViewButtons}
                onPress={() => {
                  navigation.navigate('List Of Care Givers')
                }}
              >
              ...
              >
                <Text style={{ color: 'white' }}>Compliance</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={styles.scrollViewButtons}
                onPress={() => {
                  navigation.navigate('EVVExceptionSelector')
                }}
              >
                <Text style={{ color: 'white' }}>EVV Exceptions</Text>
              </TouchableOpacity>

              <TouchableOpacity
                style={styles.scrollViewButtons}
                onPress={() => {
                  navigation.navigate('Member General Notes')
                }}
              >
                <Text style={{ color: 'white' }}>Other Reports</Text>
              </TouchableOpacity>

              <TouchableOpacity
                style={styles.scrollViewButtons}
                onPress={() => {
                  navigation.navigate('ListOfMembers')
                }}
              >
              ...
              >
                <Text style={{ color: 'white' }}>Visits</Text>
              </TouchableOpacity>
            </ScrollView>
          </View>
