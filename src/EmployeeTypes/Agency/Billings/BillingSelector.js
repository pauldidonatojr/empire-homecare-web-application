...
const BillingSelector = ({ navigation }) =>{
    return (
        <View style={{ width: '100%', height: '100%' }}>
            ...
            <View style={styles.filterHolder}>
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => {
                        navigation.navigate('Prebilling Review')
                    }}
                >
                    <Text style={{ color: 'white' }}>Pre Billing Review</Text>
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.filterHolder}>
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => {
                        navigation.navigate('Billing Review Search')
                    }}
                >
                    <Text style={{ color: 'white' }}>Billing Review</Text>
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.filterHolder}>
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => {
                        navigation.navigate('Invoice Search Selector')
                    }}
                >
                    <Text style={{ color: 'white' }}>Invoice Search</Text>
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.filterHolder}>
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => {
                        navigation.navigate('New Invoice Batch')
                    }}
                >
                    <Text style={{ color: 'white' }}>New Invoice Batch</Text>
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.filterHolder}>
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => {
                        navigation.navigate('ElectronicBillingSelector')
                    }}
                >
                    <Text style={{ color: 'white' }}>Electronic Billing</Text>
                </TouchableOpacity>
            </View>
