...
const BillinReviewSearch = () => {
  const [selected, setSelected] = React.useState("");

  const ByGroupMcoDropdown = [
    { key: "1", value: "All" },
    { key: "2", value: "Default" },
  ];
  ...
  const HoldReasonDropdown = [
    { key: "1", value: "All" },
    { key: "2", value: "Default" },
  ];
  const DisplayZeroResultsDropdown = [
    { key: "1", value: "Yes" },
    { key: "2", value: "No" },
  ];
          ...
          <ScrollView>
            <View style={styles.dropdown}>
              <SelectList
                ...
                data={ByGroupMcoDropdown}
                placeholder="By Group (MCO)"
                save="value"
              />
            </View>
            <View style={styles.dropdown}>
            ...
            <TextInput
              style={styles.input}
              placeholder="Vist From Date DD/MM/YY"
            />

            <TextInput
              style={styles.input}
              placeholder="Visit To Date DD/MM/YY"
            />

            <View style={styles.dropdown}>
              <SelectList
                setSelected={(val) => setSelected(val)}
                data={DisplayZeroResultsDropdown}
                placeholder="Display Zero Results"
                save="value"
              />
            </View>
            ...
            <TextInput
              style={styles.input}
              placeholder="Invoice From Date DD/MM/YY"
            />
            <TextInput
              style={styles.input}
              placeholder="Invoice To Date DD/MM/YY"
            />
            <TextInput style={styles.input} placeholder="Service Code" />
...
export default BillinReviewSearch;
