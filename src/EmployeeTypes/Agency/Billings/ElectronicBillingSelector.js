...
const ElectronicBillingSelector = ({ navigation }) =>{
    return (
        <View style={{ width: '100%', height: '100%' }}>
            ...
            <View style={styles.filterHolder}>
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => {
                        navigation.navigate('ResubmitClaims')
                    }}
                >
                    <Text style={{ color: 'white' }}>Re Submit Claims</Text>
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.filterHolder}>
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => {
                        navigation.navigate('BatchSearch')
                    }}
                >
                    <Text style={{ color: 'white' }}>Batch Search</Text>
                </TouchableOpacity>
            </View>
...
export default ElectronicBillingSelector;