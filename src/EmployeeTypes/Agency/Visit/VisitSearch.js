          ...
          <TouchableOpacity>
            <ListItem key={i} bottomDivider style={styles.ListItem}>
              <ListItem.Content>
                ...
                <ListItem.Subtitle>
                  {" "}
                  <Text>Cordinator :</Text> {l.Discipline}
                </ListItem.Subtitle>

                <ListItem.Subtitle>
                  {" "}
                  <Text>Admission ID :</Text> {l.Code}
                </ListItem.Subtitle>

                <ListItem.Subtitle>
                  {" "}
                  <Text>Member Name :</Text> {l.AltCaregiverCode}
                </ListItem.Subtitle>

                <ListItem.Subtitle>
                  {" "}
                  <Text>CareGiver IN :</Text> {l.SSN}
                </ListItem.Subtitle>
                ...
                <ListItem.Subtitle>
                  <Text>Assigmnet ID:</Text> {l.Status}
                </ListItem.Subtitle>
                <ListItem.Subtitle>
                  <Text>MCO:</Text> {l.Status}
                </ListItem.Subtitle>
              </ListItem.Content>
            </ListItem>
          </TouchableOpacity>
      ...
      <View>
        ...
        >
          ...
          <ScrollView>
            ...
            <TextInput style={styles.input} placeholder="Caregiver IN" />
            ...
            <TextInput style={styles.input} placeholder="Assigmnet ID" />
