...
const VisitSelector = ({ navigation }) =>{
    return (
        <View style={{ width: '100%', height: '100%' }}>
            ...
            <View style={styles.filterHolder}>
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => {
                        navigation.navigate('Call Dashboard')
                    }}
                >
                    <Text style={{ color: 'white' }}>Call Dashboard</Text>
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.filterHolder}>
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => {
                        navigation.navigate('Visit Search')
                    }}
                >
                    <Text style={{ color: 'white' }}>Visit Search</Text>
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.filterHolder}>
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => {
                        navigation.navigate('Visit Quick Entry')
                    }}
                >
                    <Text style={{ color: 'white' }}>Visit Quick Entry</Text>
                </TouchableOpacity>
            </View>
