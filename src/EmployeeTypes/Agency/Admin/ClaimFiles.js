      ...
      <View>
        ...
        >
          ...
          <ScrollView>
            ...
            <TextInput
              style={styles.input}
              placeholder="AR Export From Date DD/MM/YY"
            />
            <TextInput
              style={styles.input}
              placeholder="AR Export To Date DD/MM/YY"
            />
            <TextInput
              style={styles.input}
              placeholder="Billing Export From Date DD/MM/YY"
            />
            <TextInput
              style={styles.input}
              placeholder="Billing Export To Date DD/MM/YY"
            />
            <View style={styles.dropdown}>
              <SelectList
                setSelected={(val) => setSelected(val)}
