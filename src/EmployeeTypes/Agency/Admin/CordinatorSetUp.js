...
const CordinatorSetup = ({ navigation }) =>{
    return (
        <View style={{ width: '100%', height: '100%' }}>
            ...
            <ScrollView>
              <TouchableOpacity
                ...
                onPress={() => {
                  navigation.navigate('New Cordinator')
                }}
              >
                <Text style={{ color: 'white' }}>New Cordinator</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={styles.scrollViewButtons}
                onPress={() => {
                  navigation.navigate('Cordinator Search')
                }}
              >
                <Text style={{ color: 'white' }}>Search Cordinator</Text>
              </TouchableOpacity>
...
export default CordinatorSetup;