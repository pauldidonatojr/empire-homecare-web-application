...
const ActionSelector = ({ navigation }) =>{
    return (
        <View style={{ width: '100%', height: '100%' }}>
            ...
            <View style={styles.filterHolder}>
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => {
                        navigation.navigate('Pending Placement Queue')
                    }}
                >
                    <Text style={{ color: 'white' }}>Pending Placement Queue {'(Provider)'}</Text>
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.filterHolder}>
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => {
                        navigation.navigate('Communication Message Center')
                    }}
                >
                    <Text style={{ color: 'white' }}>Communications {'(Message Center)'}</Text>
                </TouchableOpacity>
            </View>
